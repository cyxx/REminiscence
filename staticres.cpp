...
const char *const Game::_monsterNames[2][4] = {
	{ // PC
		"junky",
		"mercenai",
		"replican",
...
const char *const LocaleData::_textsTableIT[LocaleData::LI_NUM] = {
...
const char *const ModPlayer::_names[] = {
	"intro",       "introb",
	"options",     "options2",
	"journal",     "options1",
	"ceinture",    "ceinturea",
...
const char *const SeqPlayer::_namesTable[] = {
	/* 0x00 */
...
const char *const ResourcePaq::_names[] = {
